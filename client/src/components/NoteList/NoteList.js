...
const NoteList = (props) => {
    ...
    return (
        <div className="note-list">
            <div className="note-list_header">
                <div className="note-list_header-title">
                    <h1>{title}</h1>
                </div>
                <div className="note-list_header-sub-head">
                    <div className="note-count">
                        {notesContext.notesState.length} note
                    </div>
                </div>
            </div>
            <div className="note-list_body">
                {
                    notesContext.notesState.length > 0 ? notesContext.notesState.map((note) => (
                        <NavLink key={note._id} className="note-card" to={
                            ...
                            <div className="note-card_head">
                                <div className="note-card_title">
                                    {note.title}
                                </div>
